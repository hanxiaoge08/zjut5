...
<div class="container">
    <div class="one">
        ...
        <div class="two">
            ...
            while (true) {
                ...
                for (Wenjuan wenjuan : ar) {
                	if(id.equals(wenjuan.getW_id()+"")){
        %>
        <tr align="center">
            <td align="center"><%=wenjuan.getW_title()%>
            </td><br>
                <%
			}
            }
		...
		%>
            <font color="red">*</font><label for="text1" >学号：</label>
				<input type="Text" id="text1" name="text1" placeholder="学号" />
				<font color="red">*</font><label for="key">姓名：</label>
				<input type="Text" id="key" name="key" placeholder="姓名"/><br>
